 ...
 * documented in [MapPinCategory]. Confirming drops a pin at a fixed, roughly-centred local
 * position rather than a real geographic one: there is no map-tap-to-place UX designed yet and
 * no real coordinate system to place it in (see [MapPin]'s own doc comment).
 */
@Composable
