...
import app.betar.comm.ble.BleTransportDriver
import app.betar.comm.ble.MeshEventSink
import app.betar.comm.wifidirect.WifiDirectTransportDriver
 ...
 * at the transport layer, which per [app.betar.comm.wifidirect.WifiPeerRegistry]'s own doc
